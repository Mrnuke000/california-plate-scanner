...
print ("California DMV personalized plate availability checker by Kris Linquist (liamyates55@outlook.com)")

if len(sys.argv) < 2:

	print ("Usage: python plate.py PLATE1 <PLATE2> <PLATE3> ...")	print ("** Please omit all spaces.  The DMV considers \"HACK THS\" the same plate as HACKTHS")
...
# We must first fill out the form describing whether this is a car/moto/etc.  It doesn't matter for availability, but this sets a required cookie
